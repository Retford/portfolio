...
export const JiraIcon = forwardRef<SVGSVGElement, SVGProps<SVGSVGElement>>(
  (props, ref) => {
    return (
      <svg
      ...
      >
        ...
        <path
          fill='#2684ff'
          d='M106.691 2.387h-45.16c0 11.258 9.114 20.37 20.367 20.37h8.309v8.04c0 11.258 9.113 20.371 20.371 20.371V6.273a3.89 3.89 0 0 0-3.887-3.886m0 0'
        ></path>
        <path
          fill='url(#deviconJiraWordmark0)'
          d='M84.313 24.902h-45.16c0 11.258 9.109 20.368 20.367 20.368h8.308v8.042c0 11.258 9.113 20.372 20.371 20.372V28.789a3.89 3.89 0 0 0-3.886-3.887m0 0'
        ></path>
        <path
          fill='url(#deviconJiraWordmark1)'
          d='M61.934 47.414H16.77c0 11.258 9.113 20.371 20.37 20.371h8.31v8.043c0 11.254 9.112 20.367 20.37 20.367V51.301a3.89 3.89 0 0 0-3.886-3.887m0 0'
        ></path>
        <path
          fill='#253858'
