...
export const StoryBookIcon = forwardRef<SVGSVGElement, SVGProps<SVGSVGElement>>(
  (props, ref) => {
    return (
      <svg
      ...
      >
        ...
        <mask id='logosStorybookIcon1' fill='#fff'>
          <use href='#logosStorybookIcon0'></use>
        </mask>
        <use fill='#FF4785' href='#logosStorybookIcon0'></use>
        <path
          fill='#FFF'
